 ...
 * @icon fa fa-circle-o
 */
class Paymentmanagement extends Backend
{
    
    /**
     * Paymentmanagement模型对象
     * @var \app\admin\model\Paymentmanagement
     */
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            foreach ($list as $row) {
                $row->visible(['id','Redeemtheaccount','username','dingdanhao','Amount','Handlingee','Redeemtheaccountqmoney','Redeemtheaccounthmoney','beizhu','createtime','updatetime','operator']);
