<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/www/wwwroot/baidu.com/public/../application/admin/view/dashboard/index.html";i:1567193908;s:65:"/www/wwwroot/baidu.com/application/admin/view/layout/default.html";i:1562338656;s:62:"/www/wwwroot/baidu.com/application/admin/view/common/meta.html";i:1562338656;s:64:"/www/wwwroot/baidu.com/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<div class="panel panel-default panel-intro">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo $renminbicunkuan; ?></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo $renminbituikuan; ?></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span><?php echo $renminbiqitashouru; ?></span>
					...
					<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbiduimeijinzhuanru; ?></span> 
                                <?php echo __('zong  duihuan meijinshouru'); ?>
                            </div>
                        </div>
                    </div>
					<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbiduimeijinzhuanchu; ?></span> 
                                <?php echo __('zong  duihuan meijinzhichu'); ?>
                            </div>
                        </div>
                    </div>
								<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbichukuan; ?></span>
                                <?php echo __('renminbichukuan'); ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbizhichu; ?></span>
                                <?php echo __('zhi chu'); ?>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbishouxufei; ?></span>
                                <?php echo __('shou xu fei'); ?>
                            </div>
                        </div>
                    </div>
               <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $wuzhukuandairuzhang; ?></span> <!--无主款待入账-->
                                <?php echo __('wuzhukuandairuzhang'); ?>
                            </div>
                        </div>
                    </div>  
                   ...
                   <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $shourudairuzhang; ?></span> <!--收入待入账-->
                                <?php echo __('shourudairuzhang'); ?>
                            </div>
                        </div>
                    </div>                
                        ...
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $zhichudairuzhang; ?></span> <!--支出待入账-->
                                <?php echo __('zhichudairuzhang'); ?>
                            </div>
                        </div>
                    </div>       
                              <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbijingshouzhi; ?></span> <!--人民币净收支-->
                                <?php echo __('renminbijingshouzhi'); ?>
                            </div>
                        </div>
                    </div>    
					...
					<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbijingzichan; ?></span>
                                <?php echo __('rmb  jing jie yu'); ?>
                            </div>
                        </div>
                    </div>	
					...
					<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbisanfangweijie; ?></span>
                                <?php echo __('renminbisanfangweijie'); ?>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbibeiyongjin; ?></span>
                                <?php echo __('renminbibeiyongjin'); ?>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $renminbilinshidongjie; ?></span>
                                <?php echo __('renminbilinshidongjie'); ?>
                            </div>
                        </div>
                    </div>
	...
	<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $zhengchangzichan; ?></span>
                                <?php echo __('zhengchangzichan'); ?>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $zhengchangzichan - $renminbisanfangweijie - $renminbibeiyongjin; ?> </span>
                                <?php echo __('houtaikeyongzichan'); ?>
                            </div>
                        </div>
                    </div>					
...
<div class="row">
                        ...
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinchoushizichan; ?></span>
                                <?php echo __('mj  choushi jie yu'); ?>
                            </div>
                        </div>
                    </div>
				<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijintuikuan; ?></span>
                                <?php echo __('mj zongtuikuan'); ?>
                            </div>
                        </div>
                    </div>
				<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinqitashouru; ?></span>
                                <?php echo __('mj zongqitashoru'); ?>
                            </div>
                        </div>
                    </div>
                    		<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinduimeijinzhuanru; ?></span>
                                <?php echo __('meijinduimeijinzhuanru'); ?>
                            </div>
                        </div>
                    </div>	
				<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinduimeijinzhuanchu; ?></span>
                                <?php echo __('meijinduimeijinzhuanchu'); ?>
                            </div>
                        </div>
                    </div>					
                        ...
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinzhichu; ?></span>
                                <?php echo __('mj zongzhichu'); ?>
                            </div>
                        </div>
                    </div>					
                        ...
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinshouxufei; ?></span>
                                <?php echo __('mj zongshouxufei'); ?>
                            </div>
                        </div>
                    </div>
						<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinjingzichan; ?></span>
                                <?php echo __('mj jing jie yu'); ?>
                            </div>
                        </div>
                    </div>	
						<div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinjinbeiyongjin; ?></span>
                                <?php echo __('meijinbeiyongjin'); ?>
                            </div>
                        </div>
                    </div>	
                        ...
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $yinliuchoujiangbeiyong; ?></span>
                                <?php echo __('yinliuchoujiangbeiyong'); ?>
                            </div>
                        </div>
                    </div>	
                        ...
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $tuiguangchoujiangbeiyong; ?></span>
                                <?php echo __('tuiguangchoujiangbeiyong'); ?>
                            </div>
                        </div>
                    </div>	
                        ...
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinzhichudairuzhang; ?></span>
                                <?php echo __('meijinzhichudairuzhang'); ?>
                            </div>
                        </div>
                    </div>	
                        ...
                        <div class="sm-st clearfix">
                            <span class="sm-st-icon st-green"><i class="fa fa-cny"></i></span>
                            <div class="sm-st-info">
                                <span><?php echo $meijinjingzichan - $meijinjinbeiyongjin - $tuiguangchoujiangbeiyong -$yinliuchoujiangbeiyong; ?></span>
                                <?php echo __('houtaimeijinjieyu'); ?>
                            </div>
                        </div>
                    </div>	
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                <ul class="products-list product-list-in-box">
                                    <?php $__FOR_START_601309384__=1;$__FOR_END_601309384__=8;for($i=$__FOR_START_601309384__;$i < $__FOR_END_601309384__;$i+=1){ ?>
                                    <li class="item">
