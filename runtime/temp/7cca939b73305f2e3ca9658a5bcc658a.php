<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/www/wwwroot/baidu.com/public/../application/admin/view/paymentmanagement/add.html";i:1569102694;s:65:"/www/wwwroot/baidu.com/application/admin/view/layout/default.html";i:1562338656;s:62:"/www/wwwroot/baidu.com/application/admin/view/common/meta.html";i:1562338656;s:64:"/www/wwwroot/baidu.com/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<select id = "zhuanru" class="province form-control" name="row[Redeemtheaccount]" data-url="/admin/category/banklist"></select>
    ...
    <div class="form-group" style="display: none;">
        ...
        <div class="col-xs-12 col-sm-5">
            ...
            <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Pingtaidingdanhao'); ?>:</label>
        <div class="col-xs-12 col-sm-5">
            <input id="c-beizhu" class="form-control" name="row[pingtaidingdanhao]" type="text">
        </div>
    </div>
    <div class="form-group">
