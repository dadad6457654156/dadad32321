<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/www/wwwroot/baidu.com/public/../application/admin/view/accountmanagement/add.html";i:1566231792;s:65:"/www/wwwroot/baidu.com/application/admin/view/layout/default.html";i:1562338656;s:62:"/www/wwwroot/baidu.com/application/admin/view/common/meta.html";i:1562338656;s:64:"/www/wwwroot/baidu.com/application/admin/view/common/script.html";i:1562338656;}*/ ?>
<!DOCTYPE html>
...
<select class="province form-control" name="row[type]" data-url="/admin/category/typeaa"></select>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Initialbalance'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-Initialbalance" data-rule="required" class="form-control" name="row[Initialbalance]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Balance'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-balance" class="form-control" name="row[balance]" type="text">
        </div>
    </div>
    <div class="form-group">
